...
const dataSets = [
  {
    productName: "Milk 5 Chocolate",
    sku: "QM050108",
    originalPrice: "€0.295",
    discount: "15%",
    promoPrice: "€0.250",
    validity: "2024-11-25 to 2024-11-25",
    status: "Active",
  },
  {
    productName: "Milk 5 Chocolate",
...
const filterableColumns = ["productName", "status"];

export default function DiscountViewDetailsData() {
  ...
  //   table skeleton
  const DiscountDetailsTableSkeleton = () => (
    <div className="pt-4">
  ...
  const DiscountDetailsTable = () => {
    ...
    const StatusBadge = ({ status }) => {
      const statusColors = {
        Active: "bg-[#22C55E26] text-[#22C55E]",
        Scheduled: "bg-[#2248C526] text-[#2248C5]",
        Inactive: "bg-[#C55E2226] text-[#C55E22]",
      };
      return (
        <span
    ...
    const columns = useMemo(
      () => [
        ...
        { field: "originalPrice", header: "Original Price" },
        { field: "discount", header: "Discount" },
        { field: "promoPrice", header: "Promo Price" },
        { field: "validity", header: "Validity Dates" },
        {
          field: "status",
          header: "Status",
        ...
        },
        {
          ...
          body: (rowData) => (
            <div className="flex items-center gap-2">
              {/* Pencil for Active/Scheduled, Repeat for Inactive */}
              {rowData.status === "Inactive" ? (
                <button
                  onClick={() => console.log("Repeat", rowData)}
                  className="w-8 h-8 rounded-md flex items-center justify-center hover:bg-gray-100 dark:hover:bg-[#111111]"
                  title="Repeat"
                >
                  <Icon
                    icon="iconoir:repeat"
                    className="text-[#EA7D00]"
