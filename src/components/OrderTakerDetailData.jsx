...
const OrderDetailDataSets = [
  {
    orderId: "#45645645",
    ownerName: "Sundar Lal",
...
const shopDetailsTabTitles = [
  {
    heading: "Shops",
    subheading: "Real-time data on shops and their owners.",
  },
];

const shopDetailDataSets = [
  {
    ownerName: "Sundar Lal",
    shopName: "Gupta Store",
    mobile: "+91 5435345",
    email: "shraiy@gmail.com",
    postCode: "L24/MK42",
    action: "Order Details",
  },
  {
...
export default function OrderTakerDetailData() {
  ...
  //   table skeleton
  const OrderDetailTableSkeleton = () => (
    <div className="pt-4">
  ...
  const OrderDetailsTable = () => {
    ...
    const rawData = OrderDetailDataSets;

    // unique filter values (status) — computed from rawData
    const uniqueFilterValues = useMemo(
      () => ({
        ownerName: [
          ...new Set(rawData.map((r) => r.ownerName).filter(Boolean)),
        ],

        shopName: [...new Set(rawData.map((r) => r.shopName).filter(Boolean))],
    ...
    const StatusBadge = (rowData) => {
      const statusColors = {
        ...
        Dispatched: "bg-[#2794DD26] text-[#2794DD]",
    ...
    const columns = useMemo(() => [
      ...
      },
      {
        ...
        header: "Action",
        body: (rowData) => (
          <button className="w-[100px] h-[28px] flex items-center justify-center text-center bg-[#EA7D00] text-white dark:text-black text-[12px] rounded">
            View Details
          </button>
        ),
      },
          ...
          <div className="flex flex-col md:flex-row gap-2 items-center w-full">
            <div className="flex flex-col gap-1 w-full">
              <h2 className="text-[#333333] dark:text-[#F2F2FE] font-bold text-[16px] lg:text-[18px]">
                {orderDetailsTabTitles[0].heading}
              </h2>
              <p className="text-[12px] lg:text-[14px] text-[#666666] dark:text-[#F2F2FE]">
                {orderDetailsTabTitles[0].subheading}
              </p>
            </div>
            <div className="flex flex-col md:flex-row justify-end items-start lg:items-end gap-4 w-full">
  ...
  const ShopDetailTable = () => {
    ...
    const rawData = shopDetailDataSets;
      ...
      <div className="pt-4">
        <div className="bg-white dark:bg-[#000000] rounded-lg p-4 h-auto">
          <div className="flex flex-col md:flex-row gap-2 items-center w-full">
            <div className="flex flex-col gap-1 w-full">
              <h2 className="text-[#333333] dark:text-[#F2F2FE] font-bold text-[16px] lg:text-[18px]">
                {shopDetailsTabTitles[0].heading}
              </h2>
              <p className="text-[12px] lg:text-[14px] text-[#666666] dark:text-[#F2F2FE]">
                {shopDetailsTabTitles[0].subheading}
              </p>
            </div>
            <div className="flex flex-col md:flex-row justify-end items-start lg:items-end gap-4 w-full">
              <div className="ml-0 lg:ml-4">
    ...
    return (
      <>
        <div className="pt-4 space-y-4 relative">
          ...
          <OrderDetailTableSkeleton />

          {/* sop detail table skeleton */}
          <ShopDetailTableSkeleton />
        </div>
      </>
    );
  }
