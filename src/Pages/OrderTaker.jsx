...
import OrderTakerData from "../components/OrderTakerData";
      ...
      <div className="flex-1 pl-3 pr-3 pt-4 bg-gray-50 dark:bg-[#141414]">
        {isLoading ? (
          <>
            ...
            <CardsSkeleton />
            {/* order data */}
            <OrderTakerData isLoading={true} key={key} />
          </>
        ) : (
          <>
            {/* buttons */}
            ...
            {/* row 3 Table */}
            <OrderTakerData isLoading={isLoading} key={key} />
