...
export default function ManufacturerAddSuccessModal({
  closeModal,
  topHeading = "Manufacturer Added Successfully",
  centerText = "The manufacturer has been added to your list. You can now manage their details & track purchases.",
}) {
  const { openModal, closeModal: closeManufacturerAddSuccessModal } =
    useModal();
