...
export default function ManufacturerOrderSummaryModal({ closeModal }) {
  const { openModal, closeModal: closeManufacturerOrderSummaryModal } =
    useModal();
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Summary Footer */}
      <div className="overflow-auto max-h-[30vh] px-3 scrollbar-thin scrollbar-thumb-[#8E8E9C2E] scrollbar-track-[#F2F2FE] dark:scrollbar-thumb-[#8E8E9C2E] dark:scrollbar-track-[#141414]">
        <div className="bg-[#EA7D000F] dark:bg-[#EA7D000F] p-4 rounded-lg space-y-2">
