...
export default function EditRoleAndPermissionsModal({ closeModal }) {
  ...
  const [email, setEmail] = useState("shraiy@gmail.com");
  ...
  const handleCancel = () => {
    setChecked(new Set(savedChecked)); // revert
    closeModal();
  };
